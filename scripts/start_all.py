...
SERVICES = [
    {
        ...
        "cmd": [PYTHON_BIN, "-m", "uvicorn", "app.main:app", "--app-dir", "backend", "--host", "127.0.0.1", "--port", "8000"],
        "cwd": str(ROOT_DIR),
    },
    {
        ...
        "cmd": ["npm", "--prefix", "frontend-farmer-pwa", "run", "preview", "--", "--port", "3000", "--host", "127.0.0.1"],
        "cwd": str(ROOT_DIR),
    },
    {
        ...
        "cmd": ["npm", "--prefix", "frontend-fpo-portal", "run", "preview", "--", "--port", "3001", "--host", "127.0.0.1"],
        "cwd": str(ROOT_DIR),
    },
    {
        ...
        "cmd": ["npm", "--prefix", "frontend-lender-dashboard", "run", "preview", "--", "--port", "3002", "--host", "127.0.0.1"],
        "cwd": str(ROOT_DIR),
    },
]
